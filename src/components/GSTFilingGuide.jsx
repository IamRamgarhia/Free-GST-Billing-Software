...
const GSTR1_STEPS = [
  ...
  },
  {
    ...
    details: 'Click "4A, 4B, 4C, 6B, 6C — B2B Invoices" → Click "Add Invoice" → Enter receiver GSTIN, Invoice No, Date, Total Value, Place of Supply, and tax details (CGST/SGST or IGST). Use your Free GST Billing Software B2B report data to fill each invoice. Add all invoices with GSTIN clients.',
  },
  {
    title: 'Table 5 — B2C Large (Inter-state > ₹2.5L)',
    details: 'Click "5A, 5B — B2C (Large) Invoices" → Add inter-state invoices above ₹2.5 lakh to unregistered persons. Enter Place of Supply, Rate, Taxable Value, and IGST. Check your Free GST Billing Software B2C report for invoices meeting this threshold.',
  },
  {
    title: 'Table 7 — B2C Small (Others)',
    details: 'Click "7 — B2C (Others)" → This is for all remaining B2C invoices (intra-state + inter-state below ₹2.5L). Enter aggregated taxable value and tax by rate. Free GST Billing Software auto-aggregates this in your B2C report.',
  },
  {
    title: 'Table 9 — HSN Summary',
    details: 'Click "12 — HSN-wise Summary of Outward Supplies" → Enter each HSN/SAC code with total quantity, taxable value, and tax breakup. Use your Free GST Billing Software HSN Summary report. HSN is mandatory if turnover > ₹5 Crore (6-digit) or > ₹1.5 Crore (4-digit).',
  },
  {
    title: 'Table 13 — Document Summary',
    details: 'Click "13 — Documents Issued" → Enter the range of invoice numbers issued during the period. Example: From INV/2025-26/0001 To INV/2025-26/0015, Total: 15, Cancelled: 0. Free GST Billing Software shows this in the Document Summary tab.',
  },
  {
...
const GSTR3B_STEPS = [
  ...
  },
  {
    ...
    details: 'Enter (a) Taxable outward supplies to registered persons (B2B total from Free GST Billing Software), (b) Taxable outward supplies to unregistered persons (B2C total), (c) Zero-rated/export supplies, (d) Inward supplies on reverse charge, (e) Non-GST supplies. Fill taxable value and tax (IGST, CGST, SGST/UTGST, Cess).',
  },
  {
  ...
  },
  {
    ...
    details: 'Enter ITC from (A) Import of goods, (B) Import of services, (C) Inward supplies on reverse charge, (D) ITC from ISD, (E) All other ITC. Use your Free GST Billing Software Expenses GST total for eligible ITC in row (E). Also enter ITC reversed and net ITC available.',
  },
  {
    ...
    <div className="dashboard-container">
      ...
      <div className="glass-panel p-6 mb-6" style={{ borderLeft: '4px solid var(--primary)' }}>
        ...
        <ul style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: 1.8, paddingLeft: '1.25rem' }}>
          ...
          <li>Use your <strong>GST Reports</strong> page in Free GST Billing Software to get all the numbers you need</li>
        ...
        <>
          ...
          <div className="glass-panel p-6" style={{ background: '#f0fdf4' }}>
            ...
            <ul style={{ fontSize: '0.85rem', color: '#047857', lineHeight: 1.8, paddingLeft: '1.25rem' }}>
              <li>Use Free GST Billing Software's "B2B CSV" export — it matches the GST portal format</li>
        ...
        <>
          ...
          <div className="glass-panel p-6" style={{ background: '#eff6ff' }}>
            ...
            <ul style={{ fontSize: '0.85rem', color: '#1e40af', lineHeight: 1.8, paddingLeft: '1.25rem' }}>
              ...
              <li>Track your ITC in Free GST Billing Software's Expense Tracker — enter vendor GSTIN for eligible claims</li>
